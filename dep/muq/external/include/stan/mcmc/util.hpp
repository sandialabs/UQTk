...
namespace stan {
  ...
  namespace mcmc {
    ...
    inline void write_error_msgs(std::ostream* error_msgs,
     ...
     */
    inline double leapfrog(stan::model::prob_grad& model, 
                    std::vector<int> z,
    ...
    inline double rescaled_leapfrog(stan::model::prob_grad& model, 
                             std::vector<int> z, 
     ...
     inline  double nondiag_leapfrog(stan::model::prob_grad& model,
                              std::vector<int> z,
      ...
      inline void read_cov(std::string& cov_file,
   ...
   inline  int sample_unnorm_log(std::vector<double> probs, 
