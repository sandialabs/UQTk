c===========   L-BFGS-B (modified version January 17, 2011  ===================
c
...
c     "Remark On Algorithm 78: L-BFGS-B: Fortran Subroutines for Large-Scale
c      Bound Constrained Optimization". Decemmber 27, 2010.
c
c     The paper describes an improvement and a correction to Algorithm 78. 
...
c     of routine dpmeps to estimate machine precision. An extra array of
c     size n is required by the new version.
c
c
...
c
c-jlm-jn
     +                 wa(2*m*n+5*n+12*m*m+12*m), dsave(29)
...
c     ************
c-jlm-jn 
      integer   l1,l2,l3,lws,lr,lz,lt,ld,lxp,lsg,lwa,lyg,
...
c======================= The end of setulb =============================
     ...
     +                  sy, ss, yy, wt, wn, snd, z, r, d, t, xp, wa, sg,
...
c     ************
     ...
     +                 gd,gdold,stp,stpmx,time
      double precision one,zero,dpmeps
...
c
 ...
 55   continue
      if ( dd_p .gt.zero ) then
         ...
         write(6,*) ' Positive directional derivative '
      else
         go to 911
      endif
c
