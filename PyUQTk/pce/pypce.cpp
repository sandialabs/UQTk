...
PYBIND11_MODULE(_pce, m) {
    py::class_<PCBasis>(m,"PCBasis")
      ...
      py::class_<PCSet>(m,"PCSet")
        ...
        .def("Multiply",static_cast<void (PCSet::*)(const Array1D<double>&, const Array1D<double>&, Array1D<double>&) const>(&PCSet::Multiply))
        .def("MultiplyInPlace",static_cast<void (PCSet::*)(double*, const double*) const>(&PCSet::MultiplyInPlace))
        .def("MultiplyInPlace",static_cast<void (PCSet::*)(Array1D<double>&, const Array1D<double>&) const>(&PCSet::MultiplyInPlace))
        ...
        .def("StDv",static_cast<void (PCSet::*)(const double*) const>(&PCSet::StDv))
        .def("StDv",static_cast<void (PCSet::*)(const Array1D<double>&) const>(&PCSet::StDv))
