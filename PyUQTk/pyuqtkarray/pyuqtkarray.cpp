...
PYBIND11_MODULE(uqtkarray, m) {
    py::class_<Array1D<int><int>>(m, "Array1D<int>")
      .def(py::init<>())
      ...
      .def("DumpBinary",static_cast<void (Array1D<int>::*)(FILE*)>(&Array1D<int>::DumpBinary)))
      ...
      py::class_<Array1D<double>>(m, "Array1D<double>")
        ...
        .def("DumpBinary",static_cast<void (Array1D<double>::*)(FILE*)>(&Array1D<double>::DumpBinary)))
      ...
      py::class_<Array2D<int>>(m,"Array2D")
        ...
        .def("DumpBinary",static_cast<void (Array2D<int>::*)(FILE*)>(&Array2D<int>::DumpBinary)))
        ...
        .def_property("ysize_",&Array2D<int>::xsize_)
      ...
      py::class_<Array2D<double>>(m,"Array2D")
        ...
        .def("DumpBinary",static_cast<void (Array2D<double>::*)(FILE*)>(&Array2D<double>::DumpBinary)))
        ...
        .def("pyElement",&Array2D::operator[])
        .def("getRow",&Array2D::getRow)
